...
export class CollapseToolbar extends CollapseToolbarCommon {
    ...
    public createNativeView() {
        return new android.support.design.widget.CoordinatorLayout(this._context);
    }
    ...
    public initNativeView() {
        ...
        const clp = new android.support.design.widget.CoordinatorLayout.LayoutParams(
            android.support.design.widget.CoordinatorLayout.LayoutParams.FILL_PARENT,
            android.support.design.widget.CoordinatorLayout.LayoutParams.FILL_PARENT);

        this.nativeView.setFitsSystemWindows(true);
        ...
        const NScrollView = new android.support.v4.widget.NestedScrollView(this._context);
            const tvMyText = new android.widget.TextView(this._context);
            tvMyText.setText(`Material is the metaphor.\n\n
        ...
        NScrollView.addView(tvMyText);

        this.nativeView.addView(NScrollView);

        // const FAB = new android.support.design.widget.FloatingActionButton(this._context);
        // this.nativeView.addView(FAB);
        
        app.android.foregroundActivity.setContentView(this.nativeView, clp);
    }
